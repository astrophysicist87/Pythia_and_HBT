...
into a large production invariant time for the adjacent hadrons
(using the middle definition). This cut reject fragmented systems
where such a large tau is found, and a new try to hadronize is made.
If this variable is set too low then also correct vertices will be
rejected.  
