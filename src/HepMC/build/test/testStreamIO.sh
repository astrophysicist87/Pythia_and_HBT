...
if [ "GEV" = "GEV" ];then
  if [ "MM" = "MM" ];then
    cmd9=`diff -q -b testStreamIOVarious.cout /scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testStreamIOVarious.output`
  fi
fi
  cmd=`diff -q -b testStreamIO.cout /scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testStreamIO.output`
...
if [ "GEV" = "GEV" ];then
  ...
  cmd=`diff -q -b testStreamIO.cout /scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testStreamIO.output`
  cmd3=`sed 's/e-00/e+00/g'  /scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testHepMCParticle.output | \
...
if [ "GEV" = "GEV" ];then
  ...
  cmd=`diff -q -b testStreamIO.cout /scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testStreamIO.output`
  cmd3=`diff -q -b testStreamIOParticle.out /scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testHepMCParticle.output`
  cmd4=`diff -q -b testStreamIOVarious.out testNaN.out`
esac
