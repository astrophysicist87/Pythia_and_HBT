...
void read_testIOGenEvent(std::ostream & os)
{
    ...
    HepMC::IO_GenEvent ascii_in("/scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testIOGenEvent.input",std::ios::in);
...
void read_variousFormats(std::ostream & os)
{
    ...
    HepMC::IO_GenEvent ascii_in("/scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testHepMCVarious.input",std::ios::in);
    ascii_in.use_input_units( HepMC::Units::GEV, HepMC::Units::MM );
    // declare another IO_GenEvent for writing out the good events
...
void read_nan(std::ostream & os)
{
    ...
    //
    HepMC::IO_GenEvent xin("/scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testHepMCVarious.input",std::ios::in);
    ...
    if ( xin.error_type() != 0 ) {
        os << "processing of /scratch/blixen/plumberg/Pythia_and_HBT/src/HepMC/HepMC-2.06.09/test/testHepMCVarious.input ended with error " 
