...
(
	# info for this run
	NTHREADS=1
	DIRECTORY=results_blixen_ONE_MORE_SIMPLE_TEST
	...
	declare -a specs=(
		'projectile="p" target="p" beamEnergy="7000" chosenHBTparticle="211" Nevents=10 BEeffects="on" BEEnhancementMode="0" eventClassSelectionMode="multiplicity" runSV="false"'
