...
(
	...
	declare -a specs=(
		'projectile="p" target="p" beamEnergy="7000" chosenHBTparticle="211" Nevents=10 BEeffects="on" BEEnhancementMode="1" eventClassSelectionMode="multiplicity" runSV="false"'
