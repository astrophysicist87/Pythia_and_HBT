...
(
	...
	declare -a specs=(
		'projectile="p" target="p" beamEnergy="7000" chosenHBTparticle="211" Nevents=10 BEeffects="on" BEEnhancementMode="0" eventClassSelectionMode="centrality" runSV="false"'
